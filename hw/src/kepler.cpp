...
static inline void stiefel_Gs03(real_t* Gs0, real_t* Gs1, real_t* Gs2, real_t* Gs3, real_t beta, real_t X) {
    real_t X2 = X * X;
    real_t z = X2 * beta;
...
static inline void halley_step(real_t* X, real_t beta, real_t r0, real_t eta0, real_t zeta0, real_t dt) {
...
// static inline void stiefel_Gs13(real_t* Gs1, real_t* Gs2, real_t* Gs3, real_t beta, real_t X) {
//     real_t X2 = X * X;
//     real_t z = X2 * beta;
//     // Use a truncated Taylor series for the Stumpff functions
